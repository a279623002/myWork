...
function numadd() {
	//var dj=document.form.zfbprice.value;
	if(parseInt(document.form.quantity.value)<10){
		document.form.quantity.value=parseInt(document.form.quantity.value)+1;
		document.form.mun.value=document.form.quantity.value;
		//document.form.price.value=parseInt(dj)*parseInt(document.form.quantity.value);
		//document.getElementById("pricez").innerHTML='￥'+document.form.price.value+'元';
	}
	pricea();
}
function numreduce() {
//	var dj=document.form.zfbprice.value;
	if(parseInt(document.form.quantity.value)>1){
		document.form.quantity.value=parseInt(document.form.quantity.value)-1;
		document.form.mun.value=document.form.quantity.value;
		//document.form.price.value=parseInt(dj)*parseInt(document.form.quantity.value);
		//document.getElementById("pricez").innerHTML='￥'+document.form.price.value+'元';
...
//alert(document.form.orderid.value);
